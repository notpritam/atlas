...
export const demoCollections = [
 ...
 },
 {
  ...
  entries:[
   {key:'visual-space-v2',image:'../../apps/web/assets/studio-architecture-640.webp',title:'Make room for the thing that matters',body:'A visual reference from the FoundKeep studio: strong structure, soft light, and enough space to let the main idea breathe.',tags:['design','space']},
   {key:'quiet-canvas-v2',image:'../../apps/web/assets/foundkeep-coastal-800.webp',title:'A quieter canvas',body:'A FoundKeep landscape study. Muted tones can give an interface its atmosphere while leaving the content in focus.',tags:['design','color']},
 ...
 },
 {
  ...
  entries:[
   {key:'slow-attention-v2',image:'../../apps/web/assets/foundkeep-stillwater-800.webp',title:'A moment before the next tab',body:'A visual pause from the FoundKeep collection. Leave a little room between finding something and deciding what it means.',tags:['reading','attention']},
