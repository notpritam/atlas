...
export const betaDistribution:Record<'prod'|'dev',Distribution>={
 prod:{ios:{url:null,status:'FoundKeep 1.0.0 (build 22) is available to internal TestFlight testers. External access is waiting for beta review submission.'},android:{apkUrl:'https://foundkeep.app/downloads/foundkeep-android-1.0.0-6.apk',playUrl:null,status:'FoundKeep 1.0.0 (build 6) is available as a signed APK.'}},
