...
function ThemedRoot() {
  ...
  return <ThemeProvider value={theme}><SessionProvider><MotionProvider><MaterialProvider><StatusBar style="auto" /><NavigationController /><IncomingShares /><Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: colors.paper }, animation: 'fade' }} /></MaterialProvider></MotionProvider></SessionProvider></ThemeProvider>;
}
