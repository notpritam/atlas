...
export default function Settings() {
  ...
  return <Screen><ScrollView contentContainerStyle={[styles.page, { paddingBottom: bottomSpace }]}>
    ...
    <SettingsRow icon="sparkles-outline" label="Your plan" title={plan?.pro ? 'FoundKeep Pro' : 'Your free collection'} detail={plan?.complimentaryPro ? 'Complimentary beta access and your processing allowance.' : plan?.pro ? 'Manage your subscription and processing allowance.' : 'Explore Pro, or restore a purchase.'} onPress={() => router.push('/(app)/subscription')} />
